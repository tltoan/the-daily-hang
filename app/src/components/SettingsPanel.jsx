...
const TWK_STYLE = `
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;width:40px;height:40px;
    border-radius:50%;border:.5px solid rgba(255,255,255,.6);background:rgba(250,249,247,.85);
...
export function SettingsPanel({
  title = 'Settings',
  paletteValue, paletteOptions, onPaletteChange,
  visualValue, visualOptions, onVisualChange,
  onResetToday, onClearStats,
}) {
      ...
      {open && (
        <div ref={dragRef} className="twk-panel"
          ...
          <div className="twk-body">
            ...
            <TweakRadio label="Theme" value={paletteValue} options={paletteOptions}
                        onChange={onPaletteChange} />
            <TweakSection label="Hangman visual" />
            <TweakRadio label="Metaphor" value={visualValue} options={visualOptions}
                        onChange={onVisualChange} />
            <TweakSection label="Demo controls" />
            <TweakButton label="New day (reset today)" onClick={onResetToday} />
            <TweakButton secondary label="Clear all stats" onClick={onClearStats} />
          </div>
        </div>
      )}
    </>
